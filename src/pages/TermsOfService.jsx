  ...
  return (
    <>
      <PageMeta
        ...
        description="Review the terms and conditions for using Rana M. Zahid Muneer Advocate's services and website."
      />
            ...
            <div className="space-y-stack-lg">
              ...
              <div>
                ...
                <p className="font-sans text-body-lg text-luxe-grey mb-4 leading-relaxed">
                  Permission is granted to temporarily download one copy of the materials (information or software) on Rana M. Zahid Muneer Advocate's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
                </p>
              ...
              <div>
                ...
                <p className="font-sans text-body-lg text-luxe-grey leading-relaxed">
                  The materials on Rana M. Zahid Muneer Advocate's website are provided on an 'as is' basis. Rana M. Zahid Muneer Advocate makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-sans text-body-lg text-luxe-grey leading-relaxed">
                  In no event shall Rana M. Zahid Muneer Advocate or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on the website.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-sans text-body-lg text-luxe-grey leading-relaxed">
                  The materials appearing on Rana M. Zahid Muneer Advocate's website could include technical, typographical, or photographic errors. Rana M. Zahid Muneer Advocate does not warrant that any of the materials on the website are accurate, complete, or current. Rana M. Zahid Muneer Advocate may make changes to the materials contained on the website at any time without notice.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-sans text-body-lg text-luxe-grey leading-relaxed">
                  Rana M. Zahid Muneer Advocate has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by Rana M. Zahid Muneer Advocate of the site. Use of any such linked website is at the user's own risk.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-sans text-body-lg text-luxe-grey leading-relaxed">
                  Rana M. Zahid Muneer Advocate may revise these terms of service for the website at any time without notice. By using this website, you are agreeing to be bound by the then current version of these terms of service.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-sans text-body-lg text-luxe-grey leading-relaxed">
                  These terms and conditions are governed by and construed in accordance with the laws of Pakistan, and any disputes shall be subject to the exclusive jurisdiction of the courts of Islamabad, Pakistan.
                </p>
              </div>
